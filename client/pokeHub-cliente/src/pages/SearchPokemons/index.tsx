...
import CardCategorySearch from "../../components/CardCategorySearch";
import SearchBar from "../../components/SearchBar";
import { ContainerGlobal } from "../../styles/globalStyle";
import CardSearchPokemon from "../../components/CardSearchPokemon";
            ...
            <ContainerGlobal>
                ...
                <section className="categoriesPokemon">
                    ...
                    <div className="categoriesPokemon-cards">
                        ...
                        <Link to={`type/ghost`}>
                            <CardCategorySearch backgroundColor="#705898" title="Fantasma" image="https://assets.pokemon.com/assets/cms2/img/pokedex/full/708.png" />
                        </Link>
                        <Link to={'type/dragon'}>
                            <CardCategorySearch backgroundColor="#7038f88f" title="Dragão" image="https://assets.pokemon.com/assets/cms2/img/pokedex/full/149.png" />
                        </Link>
                        <Link to={'type/dark'}>
