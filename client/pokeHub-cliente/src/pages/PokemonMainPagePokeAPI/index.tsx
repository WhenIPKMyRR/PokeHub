...
import { useObservationData } from "../../services/ObservationsPokeHubAPIServices/useObservationPokemonData";
import { useDeleteCurrentPokemon, useUpdateCurrentPokemon, useCurrentPokemonData } from "../../services/PokemonsPokeHubAPIServices";
...
const Pokemon = () => {
  ...
  const handleToggleFavorite = async () => {
    ...
    try {
      await useUpdateCurrentPokemon(pokemon?.id, updatedData);
